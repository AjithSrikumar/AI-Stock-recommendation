...
import { TrendingUp, Calendar, DollarSign, Clock, Target, Activity } from 'lucide-react';
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
                          ...
                          <div className="w-full h-full bg-blue-100 rounded-full flex items-center justify-center" style={{ display: record.logo ? 'none' : 'flex' }}>
